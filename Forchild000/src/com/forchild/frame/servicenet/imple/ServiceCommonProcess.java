...
public class ServiceCommonProcess implements ServiceNetworkResultHandler {
	
	protected Context context;
	protected Preferences preference;

	public ServiceCommonProcess() {

	}

	public ServiceCommonProcess(Context context, Preferences preference) {
